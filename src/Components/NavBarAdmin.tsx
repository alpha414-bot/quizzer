  ...
  return (
    <>
      <div className="relative z-40">
        ...
        {/* Sidebar */}
        <aside
          className="fixed top-0 left-0 z-30 w-64 h-screen pt-14 transition-transform -translate-x-full bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
          aria-label="Sidenav"
