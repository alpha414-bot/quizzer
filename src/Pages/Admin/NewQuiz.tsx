...
import { queryToAddQuiz } from "@/System/Module/Query/Quiz";
...
const NewQuiz = () => {
  ...
  return (
    <form className="space-y-6 px-4" onSubmit={handleSubmit(setupQuizMetaData)}>
      <div>
        <p className="text-sm">
          You are about to create a new quiz, enter image, title and description
          for your quiz.
        </p>
